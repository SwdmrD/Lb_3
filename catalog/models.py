...
class Customer(models.Model):
    ...
    customer_passport_code = models.BigIntegerField('Код паспорту', unique=True, validators=[passport_validator])
...
class Item(models.Model):
    ...
    type = models.CharField('Назва',validators=[name_validator], max_length=30)
...
class Receipt(models.Model):
    ...
    id_item = models.ForeignKey(Item, on_delete=models.SET_NULL, null=True, verbose_name='Товар')
